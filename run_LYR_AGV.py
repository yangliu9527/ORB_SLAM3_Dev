...
all_seq_ids = ["road1_cut_1_12","road2_cut_1_12","playground_circle_cut_1_12","data1_checked_1_12","playground_12_27"]
...
for seq_name in seq_ids:
    ####################### run the system#######################
    os.system(f'./Examples_added/Stereo/stereo_kitti_added Vocabulary/ORBvoc.txt  ./Config/LYR-AGV/LYR-AGV-20241226-rectified.yaml {dataset_path}/{seq_name}/')
