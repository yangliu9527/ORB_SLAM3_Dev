...
for i in range(0,len(seq_names)):
    ...
    os.system(f'./Examples/Stereo/stereo_euroc Vocabulary/ORBvoc.txt Config/EuRoC/EuRoC.yaml {dataset_path}/{seq_name} Config/EuRoC/EuRoC_TimeStamps/{seq_name}.txt') 
